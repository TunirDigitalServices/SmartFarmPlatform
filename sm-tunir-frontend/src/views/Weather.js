          ...
          <Card small className="h-100">
            {
              offer === '2'
              ?
            <Card.Header className="border-bottom d-flex align-items-center justify-content-center">
                <Form.Select onChange={(e)=> {setCoord({lat :  e.target.value.split(",")[0],lon : e.target.value.split(",")[1] }); setFarmSelected(e.target.selectedOptions[0].text)}} value={coord}>
