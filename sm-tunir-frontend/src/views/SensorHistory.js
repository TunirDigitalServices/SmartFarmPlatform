...
import {
    Button, Row, Col, Form, Container, Card,
        ...
        <Container fluid className="main-content-container p-4" style={{ overflowX: "auto" }}>
            ...
            <Row className="d-flex gap-2 justify-content-between align-items-center">
                ...
                <Col lg='4' md="12" sm='12' className="form-group">
                    ...
                    <Form.Control type="date" value={dateValue.dateStart} onChange={(e) => setDateValue({ ...dateValue, dateStart: e.target.value })} />
                </Col>
                <Col lg='4' md="12" sm='12' className="form-group">
                    <p style={{ margin: "0px" }}>{t('end_date')}</p>
                    <Form.Control type="date" value={dateValue.dateEnd} onChange={(e) => setDateValue({ ...dateValue, dateEnd: e.target.value })} />
            ...
            <Row>
                <Col lg='12' md="12" sm="12" >
                    <Card>
                        <Card.Header className="border-bottom">{codeSensor !== "" ? <span>{t('sensor_code')} : {codeSensor}</span> : null}</Card.Header>
                        <Card.Body>
