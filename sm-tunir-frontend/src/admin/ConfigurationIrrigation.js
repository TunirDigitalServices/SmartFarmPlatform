        ...
        <>
            <Container className="p-4">
                ...
                <Row form className="py-2 d-flex justify-content-center">
                    <ButtonGroup>
                        <Button variant='outline-primary' onClick={() => { setToggle(true) }}>Add Irrigations Type</Button>
                    </ButtonGroup>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <ButtonGroup size="sm" className="mr-2">
                                                        ...
                                                        <Button title="Delete" onClick={() => { confirmDelete(irrigation.id) }} squared variant="danger"><i className="material-icons">&#xe872;</i></Button>
                                                    </ButtonGroup>
